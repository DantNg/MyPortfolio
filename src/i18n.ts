...
export const ui: Record<Lang, Dict> = {
  en: {
    ...
    // ---- Series học tập (trong tab Blog) ----
    'series.label': 'Series',
    'series.eyebrow': 'Learning Series',
    'series.sectionHeading': 'Learning Series',
    'series.sectionSub': 'Multi-part courses that go deeper than a single article. Every lesson is written in both English and Vietnamese — switch with EN / VI in the header.',
    'series.cta.start': 'Start with lesson 1',
    'series.cta.open': 'Open the series',
    'series.meta.lessons': 'lessons',
    'series.meta.bilingual': 'English + Tiếng Việt',
    'series.meta.code': 'copy-paste ready code',
    'series.toc': 'Lessons in this series',
    'series.lesson': 'Lesson',
    'series.prev': 'Previous lesson',
    'series.next': 'Next lesson',
    'series.back': 'All lessons in this series',
    'series.langHint': 'This lesson is available in both languages — use the EN / VI switch in the header.',
    'series.who.title': 'Who this is for',
    'series.need.title': 'What you need',
    'series.articlesHeading': 'Articles',
  ...
  vi: {
    ...
    // ---- Series học tập (trong tab Blog) ----
    'series.label': 'Series',
    'series.eyebrow': 'Series học tập',
    'series.sectionHeading': 'Series học tập',
    'series.sectionSub': 'Những khoá nhiều phần, đi sâu hơn một bài viết đơn lẻ. Mỗi bài đều có bản tiếng Việt và tiếng Anh — đổi bằng nút EN / VI trên thanh điều hướng.',
    'series.cta.start': 'Bắt đầu từ bài 1',
    'series.cta.open': 'Mở series',
    'series.meta.lessons': 'bài học',
    'series.meta.bilingual': 'Tiếng Việt + English',
    'series.meta.code': 'code dán vào là chạy',
    'series.toc': 'Các bài trong series',
    'series.lesson': 'Bài',
    'series.prev': 'Bài trước',
    'series.next': 'Bài tiếp theo',
    'series.back': 'Tất cả bài trong series',
    'series.langHint': 'Bài này có cả hai ngôn ngữ — dùng nút EN / VI trên thanh điều hướng.',
    'series.who.title': 'Dành cho ai',
    'series.need.title': 'Cần chuẩn bị gì',
    'series.articlesHeading': 'Bài viết',
